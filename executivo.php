        ...
        <div class="container-fluid">
            ...
            <article class="d-flex row">
                ...
                <div class="d-flex flex-wrap justify-content-center align-items-center">
                    ...
                    As funções do Poder Executivo no Brasil indicar os ministros ou secretários. Efetivar as leis, suprir os interesses do povo.
                    </p>
                    <img class="img-fluid order-md-2 p-3 " src="imagens/executivo.jpg" alt="Palácio do Planalto">
